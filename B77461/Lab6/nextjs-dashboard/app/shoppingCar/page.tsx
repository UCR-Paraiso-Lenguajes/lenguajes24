...
const Cart = ({ cart, setCart, toggleCart, removeProduct, clearProducts }: { cart: any, setCart: (cart: any) => void, toggleCart: (action: boolean) => void, 
    removeProduct: (product: any) => void, clearProducts: () => void}) => {
