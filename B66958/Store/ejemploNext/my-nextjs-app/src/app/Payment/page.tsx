...
const PaymentForm = ({ cart, setCart, clearProducts }:
    ...
    function handleSelectPayment(event: any) {
        ...
        if (!Object.values(PaymentMethodEnum).includes(selectedPaymentMethod)) {
            return;
        }
    ...
    async function persistPurchase() {
        ...
        try {
            ...
            else { setMessage("Método de pago no disponible"); setAlertType(1); return false;}
        } catch (error) {
    ...
    const finishPurchase = async () => {
        ...
        if(cart?.carrito?.metodoDePago >= 0){
            ...
            setMessage("Por favor seleccione un método de pago");
            setAlertType(1);
            setIsMessageShowing(true);
        }
    }
        ...
        <div className="d-grid justify-content-center gap-4">
            <div className="container">
                ...
                <div className="form-group">
                    ...
                    {(cart?.carrito?.metodoDePago === PaymentMethodEnum.SINPE) ? (
                        <>
                            <div className="container">
            ...
            {finishedSale ? (
                cart?.carrito?.metodoDePago === PaymentMethodEnum.SINPE ? <Sinpe /> : <Efectivo />
            ) : ''}
