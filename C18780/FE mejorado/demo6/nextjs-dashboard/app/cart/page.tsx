                    ...
                    <div className="col-md-9">
                        <div className="ibox">
                            ...
                            <div className="ibox-content">
                                ...
                                <Link href='/checkout'>
                                    <button className="btn btn-primary pull-right" style={{ marginLeft: '40%', display: initialCart.cart.total > 0 ? 'inline-block' : 'none' }}>
                                        <ShoppingCartIcon style={{ width: '20px' }} /> Checkout
                                    </button>
                                </Link>
                            </div>
                        </div>
