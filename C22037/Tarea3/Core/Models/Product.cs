...
namespace TodoApi.Models
{
    public class Product : ICloneable
    {
        ...
        public Category.CategorySt Category { get; private set; }

        public Product(string name, string imageURL, decimal price, string description, int id, Category.CategorySt category)
        {
