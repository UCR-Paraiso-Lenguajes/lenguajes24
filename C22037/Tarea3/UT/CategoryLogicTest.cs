...
namespace UT
{
    public class CategoryLogicTest
    {
        ...
        public void Setup()
        {
            var categories = new Category.CategorySt[]
            {
                new Category.CategorySt { Id = 1, Name = "Food and Beverages" },
                new Category.CategorySt { Id = 2, Name = "Beauty and Personal Care" }
            };
        ...
        {
            Category.CategorySt[] nullCategories = null;
