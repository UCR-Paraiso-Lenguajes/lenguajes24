...
public sealed class Store
{
 ...
 /*   public void CreateDatabase()
    {
        using (var connection = new MySqlConnection("Server=localhost;Database=mysql2;Uid=root;Pwd=123456;"))
        using (var command = connection.CreateCommand())
        {
            connection.Open();
            command.CommandText = "CREATE DATABASE IF NOT EXISTS store_db;";
